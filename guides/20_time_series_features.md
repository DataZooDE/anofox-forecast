...
The `ts_features` function extracts comprehensive time series features directly in DuckDB, providing tsfresh-compatible feature vectors for machine learning, anomaly detection, and exploratory data analysis.
