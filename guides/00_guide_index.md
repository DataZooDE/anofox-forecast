...
### 2. [Basic Forecasting](03_basic_forecasting.md)
...
### 11. [Model Selection Guide](11_model_selection.md)
...
### 13. [Performance Optimization](13_performance.md)
...
### 40. [EDA & Data Preparation](40_eda_data_prep.md) ⭐
...
### 20. [Understanding Forecasts](20_understanding_forecasts.md) ⭐
...
### 30. [Demand Forecasting](30_demand_forecasting.md) ⭐
...
### 31. [Sales Prediction](31_sales_prediction.md) ⭐
...
### 32. [Capacity Planning](32_capacity_planning.md) ⭐
...
→ [Demand Forecasting](30_demand_forecasting.md)

**...predict revenue for financial planning**
→ [Sales Prediction](31_sales_prediction.md)

**...plan staffing levels**
→ [Capacity Planning](32_capacity_planning.md)

**...choose the right model**
→ [Model Selection](11_model_selection.md)

**...understand what the forecast means**
→ [Understanding Forecasts](20_understanding_forecasts.md)

**...clean my messy data**
→ [EDA & Data Prep](40_eda_data_prep.md)

**...forecast 10,000 products quickly**
→ [Performance Optimization](13_performance.md)
...
2. [Demand Forecasting](30_demand_forecasting.md) OR [Sales Prediction](31_sales_prediction.md) - 45 min
3. [Capacity Planning](32_capacity_planning.md) - 45 min
4. [Understanding Forecasts](20_understanding_forecasts.md) - 60 min
...
1. [Quick Start](01_quickstart.md) - 5 min
2. [Basic Forecasting](03_basic_forecasting.md) - 30 min
3. [Understanding Forecasts](20_understanding_forecasts.md) - 60 min
4. [Model Selection](11_model_selection.md) - 45 min
5. [EDA & Data Prep](40_eda_data_prep.md) - 60 min
6. [Performance Optimization](13_performance.md) - 60 min
...
1. [Quick Start](01_quickstart.md) - 5 min
2. [API Reference](10_api_reference.md) - 30 min
3. [Performance Optimization](13_performance.md) - 60 min
4. [EDA & Data Prep](40_eda_data_prep.md) - 60 min
...
```
docs/
├── METRICS.md                      - All 12 metrics documented
├── INSAMPLE_FORECAST.md            - Fitted values guide
├── EDA_DATA_PREP.md                - EDA & prep reference
├── SEASONALITY_API.md              - Seasonality functions
├── CHANGEPOINT_API.md              - Changepoint functions
└── PARAMETERS.md                   - Parameter details
```
...
**Advanced**: Check [API Reference](10_api_reference.md) and [Performance](13_performance.md)

### By Question Type

**"How do I...?"** → Search this index or [API Reference](10_api_reference.md)

**"Which model...?"** → [Model Selection](11_model_selection.md)

**"What does this mean...?"** → [Understanding Forecasts](20_understanding_forecasts.md)

**"My forecast is slow..."** → [Performance](13_performance.md)

**"My forecast is inaccurate..."** → [EDA & Data Prep](40_eda_data_prep.md)
...
- [ ] Choose appropriate model ([Model Selection](11_model_selection.md))
