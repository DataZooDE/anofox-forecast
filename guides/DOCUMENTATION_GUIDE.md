...
│   │   └── README.md.in       # Main documentation template
...
1. **Find the template**:
   ```bash
   # If editing guides/03_basic_forecasting.md
   vim guides/templates/03_basic_forecasting.md.in
   ```
...
4. **Review**:
   ```bash
   git diff guides/03_basic_forecasting.md
   ```
...
5. **Update index**:
   Edit `guides/templates/00_guide_index.md.in` to add your new guide.
...
- **Examples index**: `test/sql/docs_examples/README.md`
...
1. Check this guide
2. Review `test/sql/docs_examples/README.md`
