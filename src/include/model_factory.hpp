...
public:
    ...
    static std::unique_ptr<::anofoxtime::models::IForecaster> Create(
...
private:
    ...
    static std::vector<int> GetArrayParam(const Value& params, const std::string& key, const std::vector<int>& default_value);
