...
public:
	...
	static std::unique_ptr<::anofoxtime::core::TimeSeries>
	BuildTimeSeries(const DataChunk &timestamp_chunk, const DataChunk &value_chunk, idx_t start_idx, idx_t count);

	// Validate time series data
	static void ValidateTimeSeriesData(const DataChunk &timestamp_chunk, const DataChunk &value_chunk, idx_t start_idx,
	                                   idx_t count);
