# MFLES Models Benchmark

Comprehensive benchmark comparing Anofox and Statsforecast implementations of MFLES (Multiple Frequency Long-term Exponential Smoothing) forecasting models on M5 Competition dataset.
