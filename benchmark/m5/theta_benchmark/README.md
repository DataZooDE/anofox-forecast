# Theta Models Benchmark

Comprehensive benchmark comparing Anofox and Statsforecast implementations of Theta forecasting models on M5 Competition dataset.
