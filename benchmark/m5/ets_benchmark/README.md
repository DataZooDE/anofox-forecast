# ETS Models Benchmark

Comprehensive benchmark comparing Anofox and Statsforecast implementations of ETS (Error, Trend, Seasonality) forecasting models on M5 Competition dataset.
