"""
Statsforecast baseline benchmark - configuration-driven wrapper.

Uses shared common modules and configuration files to run statsforecast baseline models.
"""
import sys
...
from configs.statsforecast_baseline import (
    BENCHMARK_NAME,
    get_models_config,
