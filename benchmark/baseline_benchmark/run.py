...
from configs.baseline import BENCHMARK_NAME, MODELS


def run_anofox(group: str = 'Daily'):
    """
    Run Anofox baseline benchmarks on M4 dataset.
...
def run(group: str = 'Daily'):
    """
    Run complete baseline benchmark: anofox + evaluation.
    ...
    """
    print(f"{'='*80}")
    print(f"BASELINE BENCHMARK - M4 {group}")
    print(f"{'='*80}\n")
