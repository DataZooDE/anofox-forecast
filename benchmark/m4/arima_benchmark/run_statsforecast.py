"""
Statsforecast ARIMA benchmark - configuration-driven wrapper.

Uses shared common modules and configuration files to run statsforecast AutoARIMA model.
"""
import sys
...
from configs.statsforecast_arima import (
    BENCHMARK_NAME,
    get_models_config,
...
def run_benchmark(group: str = 'Daily', dataset: str = 'm4'):
    """
    Run statsforecast AutoARIMA benchmark on the selected dataset.
