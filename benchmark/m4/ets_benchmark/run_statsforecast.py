"""
Statsforecast ETS benchmark - configuration-driven wrapper.

Uses shared common modules and configuration files to run statsforecast ETS models.
"""
import sys
...
from configs.statsforecast_ets import (
    BENCHMARK_NAME,
    get_models_config,
...
def run_benchmark(group: str = 'Daily', dataset: str = 'm4'):
    """
    Run statsforecast ETS benchmarks on the selected dataset.
