"""
Statsforecast Theta benchmark - configuration-driven wrapper.

Uses shared common modules and configuration files to run statsforecast Theta models.
"""
import sys
...
from configs.statsforecast_theta import (
    BENCHMARK_NAME,
    get_models_config,
...
def run_benchmark(group: str = 'Daily', dataset: str = 'm4'):
    """
    Run statsforecast Theta benchmarks on the selected dataset.
